...
namespace DeepL
{
    public partial class VoiceTranslateJobClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_GetVoiceTranslateJobStatusServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_GetVoiceTranslateJobStatusSecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_GetVoiceTranslateJobStatusSecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
            {                s_GetVoiceTranslateJobStatusSecurityRequirement0,
            };
        partial void PrepareGetVoiceTranslateJobStatusArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid jobId,
            global::System.Collections.Generic.IList<global::DeepL.GetVoiceTranslateJobStatusIncludeItem>? include);
        partial void PrepareGetVoiceTranslateJobStatusRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid jobId,
            global::System.Collections.Generic.IList<global::DeepL.GetVoiceTranslateJobStatusIncludeItem>? include);
        partial void ProcessGetVoiceTranslateJobStatusResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVoiceTranslateJobStatusResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.VoiceTranslateJobStatusResponse> GetVoiceTranslateJobStatusAsync(
            global::System.Guid jobId,
        ...
        {
            var __response = await GetVoiceTranslateJobStatusAsResponseAsync(
                jobId: jobId,
                include: include,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.VoiceTranslateJobStatusResponse>> GetVoiceTranslateJobStatusAsResponseAsync(
            global::System.Guid jobId,
            global::System.Collections.Generic.IList<global::DeepL.GetVoiceTranslateJobStatusIncludeItem>? include = default,
            global::DeepL.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetVoiceTranslateJobStatusArguments(
            ...
            var __authorizations = global::DeepL.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetVoiceTranslateJobStatusSecurityRequirements,
                operationName: "GetVoiceTranslateJobStatusAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepL.PathBuilder(
                                path: $"/v1/jobs/voice/translate/{jobId}",
                                baseUri: ResolveBaseUri(
                                servers: s_GetVoiceTranslateJobStatusServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetVoiceTranslateJobStatusRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepL.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetVoiceTranslateJobStatusAsync",
                                pathTemplate: "$\"/v1/jobs/voice/translate/{jobId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetVoiceTranslateJobStatusResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetVoiceTranslateJobStatusResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.VoiceTranslateJobStatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.VoiceTranslateJobStatusResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.VoiceTranslateJobStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
