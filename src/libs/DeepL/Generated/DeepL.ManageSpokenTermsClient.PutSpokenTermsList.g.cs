...
namespace DeepL
{
    public partial class ManageSpokenTermsClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_PutSpokenTermsListServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_PutSpokenTermsListSecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_PutSpokenTermsListSecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
            {                s_PutSpokenTermsListSecurityRequirement0,
            };
        partial void PreparePutSpokenTermsListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string spokenTermsId,
            global::DeepL.PutSpokenTermsListParameters request);
        partial void PreparePutSpokenTermsListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string spokenTermsId,
            global::DeepL.PutSpokenTermsListParameters request);
        partial void ProcessPutSpokenTermsListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPutSpokenTermsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.SpokenTermsList> PutSpokenTermsListAsync(
            string spokenTermsId,
        ...
        {
            var __response = await PutSpokenTermsListAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.SpokenTermsList>> PutSpokenTermsListAsResponseAsync(
            string spokenTermsId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePutSpokenTermsListArguments(
            ...
            var __authorizations = global::DeepL.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PutSpokenTermsListSecurityRequirements,
                operationName: "PutSpokenTermsListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepL.PathBuilder(
                                path: $"/v3/spoken-terms/{spokenTermsId}/term-lists",
                                baseUri: ResolveBaseUri(
                                servers: s_PutSpokenTermsListServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePutSpokenTermsListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepL.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PutSpokenTermsListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPutSpokenTermsListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPutSpokenTermsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.SpokenTermsList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.SpokenTermsList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.SpokenTermsList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.SpokenTermsList> PutSpokenTermsListAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepL.PutSpokenTermsListParameters
            {
                Lang = lang,
                Entries = entries,
            };

            return await PutSpokenTermsListAsync(
                spokenTermsId: spokenTermsId,
                request: __request,
                requestOptions: requestOptions,
