...
namespace DeepL
{
    public partial class QualityEvaluationClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_SubmitQualityEvaluationServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_SubmitQualityEvaluationSecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_SubmitQualityEvaluationSecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
            {                s_SubmitQualityEvaluationSecurityRequirement0,
            };
        partial void PrepareSubmitQualityEvaluationArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::DeepL.QualityEvaluationRequest request);
        partial void PrepareSubmitQualityEvaluationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::DeepL.QualityEvaluationRequest request);
        partial void ProcessSubmitQualityEvaluationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubmitQualityEvaluationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.QualityEvaluationJobCreated> SubmitQualityEvaluationAsync(

            global::DeepL.QualityEvaluationRequest request,
            global::DeepL.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SubmitQualityEvaluationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.QualityEvaluationJobCreated>> SubmitQualityEvaluationAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubmitQualityEvaluationArguments(
            ...
            var __authorizations = global::DeepL.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitQualityEvaluationSecurityRequirements,
                operationName: "SubmitQualityEvaluationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepL.PathBuilder(
                                path: "/v1/quality-evaluation",
                                baseUri: ResolveBaseUri(
                                servers: s_SubmitQualityEvaluationServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubmitQualityEvaluationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepL.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SubmitQualityEvaluationAsync",
                                pathTemplate: "\"/v1/quality-evaluation\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubmitQualityEvaluationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Request validation failed. Common causes: - `metadata.source_language`, `metadata.target_language`, or `segments` is missing or empty. - `segments` contains more than 500 entries. - A segment's `source` or `target` exceeds 10,000 characters. - The `source_language` / `target_language` combination is not supported.
                            ...
                            // Authorization failed. Common causes: - The API key does not have access to the Quality Evaluation feature. - A free-tier key is used against the paid endpoint, or vice versa.
                            if ((int)__response.StatusCode == 403)
                            {
                                string? __content_403 = null;
                                global::System.Exception? __exception_403 = null;
                                global::DeepL.QualityEvaluationApiError? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::DeepL.QualityEvaluationApiError.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubmitQualityEvaluationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.QualityEvaluationJobCreated.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.QualityEvaluationJobCreated>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.QualityEvaluationJobCreated.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.QualityEvaluationJobCreated> SubmitQualityEvaluationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepL.QualityEvaluationRequest
            {
                Metadata = metadata,
                Segments = segments,
            };

            return await SubmitQualityEvaluationAsync(
                request: __request,
                requestOptions: requestOptions,
