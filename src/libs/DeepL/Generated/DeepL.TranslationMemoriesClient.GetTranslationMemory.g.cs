...
namespace DeepL
{
    public partial class TranslationMemoriesClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_GetTranslationMemoryServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_GetTranslationMemorySecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_GetTranslationMemorySecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
            {                s_GetTranslationMemorySecurityRequirement0,
            };
        partial void PrepareGetTranslationMemoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid translationMemoryId);
        partial void PrepareGetTranslationMemoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid translationMemoryId);
        partial void ProcessGetTranslationMemoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTranslationMemoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.TranslationMemory> GetTranslationMemoryAsync(
            global::System.Guid translationMemoryId,
            global::DeepL.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTranslationMemoryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.TranslationMemory>> GetTranslationMemoryAsResponseAsync(
            global::System.Guid translationMemoryId,
            global::DeepL.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTranslationMemoryArguments(
            ...
            var __authorizations = global::DeepL.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTranslationMemorySecurityRequirements,
                operationName: "GetTranslationMemoryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepL.PathBuilder(
                                path: $"/v3/translation_memories/{translationMemoryId}",
                                baseUri: ResolveBaseUri(
                                servers: s_GetTranslationMemoryServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTranslationMemoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepL.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTranslationMemoryAsync",
                                pathTemplate: "$\"/v3/translation_memories/{translationMemoryId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTranslationMemoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTranslationMemoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.TranslationMemory.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.TranslationMemory>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.TranslationMemory.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
