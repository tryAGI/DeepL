...
namespace DeepL
{
    public partial class ManageMultilingualGlossariesClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_CreateMultilingualGlossaryServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_CreateMultilingualGlossarySecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_CreateMultilingualGlossarySecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
        ...
        /// <summary>
        /// Create a Glossary<br/>
        /// Create a glossary containing one or more dictionaries, each holding entries for a<br/>
        /// single source and target language pair. Use the returned `glossary_id` with the<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.MultilingualGlossary> CreateMultilingualGlossaryAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.MultilingualGlossary>> CreateMultilingualGlossaryAsResponseAsync(
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::DeepL.CreateMultilingualGlossaryResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::DeepL.CreateMultilingualGlossaryResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::DeepL.ApiException<global::DeepL.CreateMultilingualGlossaryResponse>.Create(
                            ...
                            // Forbidden. The access to the requested resource is denied, because of insufficient access rights. This error is also returned when the API key is scoped but does not include the scope required for this endpoint.
                            ...
                            // Quota exceeded. Too many requests were made to the glossary endpoints recently.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.MultilingualGlossary.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.MultilingualGlossary>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.MultilingualGlossary.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.MultilingualGlossary> CreateMultilingualGlossaryAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepL.CreateMultilingualGlossaryParameters
            {
                Name = name,
