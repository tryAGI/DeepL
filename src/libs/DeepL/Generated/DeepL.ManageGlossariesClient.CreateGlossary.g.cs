            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::DeepL.MonolingualGlossary.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::DeepL.MonolingualGlossary.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
