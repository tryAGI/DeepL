...
namespace DeepL
{
    public partial class ManageGlossariesClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_CreateGlossaryServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_CreateGlossarySecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_CreateGlossarySecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
        ...
        /// **For new integrations we recommend `POST /v3/glossaries`**, which supports multiple<br/>
        /// language pairs in a single glossary.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.MonolingualGlossary> CreateGlossaryAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.MonolingualGlossary>> CreateGlossaryAsResponseAsync(
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::DeepL.CreateGlossaryResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::DeepL.CreateGlossaryResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::DeepL.ApiException<global::DeepL.CreateGlossaryResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.MonolingualGlossary.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.MonolingualGlossary>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.MonolingualGlossary.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.MonolingualGlossary> CreateGlossaryAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepL.CreateGlossaryParameters
            {
                Name = name,
