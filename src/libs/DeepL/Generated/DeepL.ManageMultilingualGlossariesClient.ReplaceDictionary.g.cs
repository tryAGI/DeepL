...
namespace DeepL
{
    public partial class ManageMultilingualGlossariesClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_ReplaceDictionaryServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_ReplaceDictionarySecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_ReplaceDictionarySecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.MultilingualGlossaryEntriesInformation> ReplaceDictionaryAsync(
            string glossaryId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.MultilingualGlossaryEntriesInformation>> ReplaceDictionaryAsResponseAsync(
            string glossaryId,
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::DeepL.ReplaceDictionaryResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::DeepL.ReplaceDictionaryResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::DeepL.ApiException<global::DeepL.ReplaceDictionaryResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.MultilingualGlossaryEntriesInformation.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.MultilingualGlossaryEntriesInformation>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.MultilingualGlossaryEntriesInformation.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.MultilingualGlossaryEntriesInformation> ReplaceDictionaryAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepL.MultilingualGlossaryEntries
            {
