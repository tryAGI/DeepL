...
namespace DeepL
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::DeepL.AutoSDKRetryOptions Retry { get; set; } = new global::DeepL.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::DeepL.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::DeepL.IAutoSDKHook>();
        ...
        public global::DeepL.AutoSDKClientOptions AddHook(
            global::DeepL.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::DeepL.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::DeepL.AutoSDKClientOptions UseAuthorizationProvider(
            global::DeepL.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::DeepL.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::DeepL.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::DeepL.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::DeepL.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::DeepL.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::DeepL.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::DeepL.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::DeepL.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::DeepL.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::DeepL.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::DeepL.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::DeepL.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::DeepL.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::DeepL.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::DeepL.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::DeepL.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::DeepL.AutoSDKClientOptions clientOptions,
            global::DeepL.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::DeepL.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::DeepL.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::DeepL.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::DeepL.AutoSDKClientOptions clientOptions,
            global::System.Func<global::DeepL.IAutoSDKHook, global::DeepL.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::DeepL.AutoSDKHookContext context)
        {
