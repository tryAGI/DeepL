...
namespace DeepL
{
    public partial class TranslationMemoriesClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_CreateTranslationMemoryImportServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_CreateTranslationMemoryImportSecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_CreateTranslationMemoryImportSecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
            {                s_CreateTranslationMemoryImportSecurityRequirement0,
            };
        partial void PrepareCreateTranslationMemoryImportArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::DeepL.CreateTranslationMemoryImportRequest request);
        partial void PrepareCreateTranslationMemoryImportRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::DeepL.CreateTranslationMemoryImportRequest request);
        partial void ProcessCreateTranslationMemoryImportResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTranslationMemoryImportResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.CreateTranslationMemoryImportResponse> CreateTranslationMemoryImportAsync(

            global::DeepL.CreateTranslationMemoryImportRequest request,
            global::DeepL.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateTranslationMemoryImportAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.CreateTranslationMemoryImportResponse>> CreateTranslationMemoryImportAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTranslationMemoryImportArguments(
            ...
            var __authorizations = global::DeepL.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTranslationMemoryImportSecurityRequirements,
                operationName: "CreateTranslationMemoryImportAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepL.PathBuilder(
                                path: "/v3/translation_memories/import",
                                baseUri: ResolveBaseUri(
                                servers: s_CreateTranslationMemoryImportServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTranslationMemoryImportRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepL.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateTranslationMemoryImportAsync",
                                pathTemplate: "\"/v3/translation_memories/import\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTranslationMemoryImportResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // You have reached the maximum number of translation memories for your account. Delete a translation memory before creating another one.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTranslationMemoryImportResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.CreateTranslationMemoryImportResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.CreateTranslationMemoryImportResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.CreateTranslationMemoryImportResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.CreateTranslationMemoryImportResponse> CreateTranslationMemoryImportAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DeepL.CreateTranslationMemoryImportRequest
            {
                SourceFile = sourceFile,
                Parameters = parameters,
            };

            return await CreateTranslationMemoryImportAsync(
                request: __request,
                requestOptions: requestOptions,
