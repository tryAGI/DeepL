...
namespace DeepL
{
    public partial class TranslationMemoriesClient
    {
        ...
        private static readonly global::DeepL.AutoSDKServer[] s_CreateTranslationMemoryExportServers = new global::DeepL.AutoSDKServer[]
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement s_CreateTranslationMemoryExportSecurityRequirement0 =
        ...
        private static readonly global::DeepL.EndPointSecurityRequirement[] s_CreateTranslationMemoryExportSecurityRequirements =
            new global::DeepL.EndPointSecurityRequirement[]
            {                s_CreateTranslationMemoryExportSecurityRequirement0,
            };
        partial void PrepareCreateTranslationMemoryExportArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid translationMemoryId);
        partial void PrepareCreateTranslationMemoryExportRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid translationMemoryId);
        partial void ProcessCreateTranslationMemoryExportResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTranslationMemoryExportResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DeepL.CreateTranslationMemoryExport> CreateTranslationMemoryExportAsync(
            global::System.Guid translationMemoryId,
            global::DeepL.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateTranslationMemoryExportAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DeepL.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DeepL.AutoSDKHttpResponse<global::DeepL.CreateTranslationMemoryExport>> CreateTranslationMemoryExportAsResponseAsync(
            global::System.Guid translationMemoryId,
            global::DeepL.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTranslationMemoryExportArguments(
            ...
            var __authorizations = global::DeepL.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTranslationMemoryExportSecurityRequirements,
                operationName: "CreateTranslationMemoryExportAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::DeepL.PathBuilder(
                                path: $"/v3/translation_memories/{translationMemoryId}/export",
                                baseUri: ResolveBaseUri(
                                servers: s_CreateTranslationMemoryExportServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTranslationMemoryExportRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DeepL.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateTranslationMemoryExportAsync",
                                pathTemplate: "$\"/v3/translation_memories/{translationMemoryId}/export\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTranslationMemoryExportResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DeepL.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // An export of this translation memory is already in progress. Poll that job instead of starting another export.
                            if ((int)__response.StatusCode == 409)
                            {
                                string? __content_409 = null;
                                global::System.Exception? __exception_409 = null;
                                global::DeepL.ErrorResponse? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::DeepL.ErrorResponse.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTranslationMemoryExportResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DeepL.CreateTranslationMemoryExport.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DeepL.AutoSDKHttpResponse<global::DeepL.CreateTranslationMemoryExport>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DeepL.CreateTranslationMemoryExport.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
